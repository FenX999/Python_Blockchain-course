...
#		Structure the input for the data transaction.
...
#		Update the transaction with an exsting or new recipient.
...
#		Raise en exception for invalid transaction
		...
		if transaction.input['amount'] != output_total:
			raise Exception('Invalid transaction outupt values')
